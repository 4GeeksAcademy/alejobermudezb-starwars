...
useEffect(()=>{
  ...
  return (
    ...
    <div className="d-flex justify-content-end me-4">
        <a className=' fs-1 arrow-l m-2' onClick={handlePrevClick}><i class="fa fa-arrow-left"></i></a>
        <a className='fs-1 arrow-r m-2' onClick={handleNextClick}><i class="fa fa-arrow-right"></i></a>
    </div>
